...
export default function Products({ addToCart }) {
  const products = [
    { id: 1, name: 'Đồng hồ Rolex', price: 5000, desc: "abc", imgUrl: prdImg1},
    { id: 2, name: 'Đồng hồ Casio', price: 150, desc: "abc", imgUrl: "https://picsum.photos/200" },
    { id: 3, name: 'Đồng hồ Omega', price: 3000, desc: "abc", imgUrl: "https://picsum.photos/200" },
    { id: 4, name: 'Đồng hồ Seiko', price: 200, desc: "abc", imgUrl: "https://picsum.photos/200" }
  ];
